...
| Google Colab |[*Google Colab*](https://colab.research.google.com)| Ferramente que permite a criação e edição de notebooks pelo navegador sem necessaria a instalar de qualquer programa no computador do usuário|
...
| Atividades | Semana 1 | Semana 2 | Semana 3 | Semana 4 | Semana 5 | Semana 6 | Semana 7 | Semana 8 |
|--|--|--|--|--|--|--|--|--|
